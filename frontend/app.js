...
if (typeof window !== 'undefined' && typeof document !== 'undefined') (function () {
  ...
  function normalizeData(data) {
    return {
      ...
      extractionPreview: data.extractionPreview || { index: 0, total: 0, canPrevious: false, canNext: false, status: 'missing', paper: { id: '', title: 'No paper preview available', ref: '' }, fields: [], source: '', error: '' },
      schemaJson: data.schemaJson || { fields: [] },
